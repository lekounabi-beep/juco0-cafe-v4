...
export function EspressoBackground() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(0,0,0,0.25)_75%,rgba(0,0,0,0.55)_100%)]" />
      <div className="absolute inset-0 bg-black/15" />
      <div className="absolute inset-0 mix-blend-overlay bg-[linear-gradient(180deg,rgba(90,55,25,0.22),rgba(40,20,10,0.30))]" />
    </div>
  );
}
